...
import { avatar, buttonContainer, buttonImage, cancelButton, modal, saveButton, title } from './ImageModalPetOwnerStyle'
import './ImageModalPetOwner.css'
...
export const ImageModalPetOwner = (imageProps: ImageModalProps) => {
  ...
  const handleSavePhoto = async () => {
    ...
    try {
      ...
      const updatedPet: PetOwner = Object.assign(
        Object.create(
          Object.getPrototypeOf(imageProps.user)),
          { ...imageProps.user, photo: newPhotoUrl },
        )

      PetOwnerServiceManager.getInstance().update(updatedPet as PetOwner)
